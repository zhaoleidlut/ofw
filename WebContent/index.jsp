...
<body>
	...
	<div region="north" id="north_region" href="layout/north.htm" style="height: 50px; overflow: hidden;background-color:lightcyan;"></div>
	<div region="west"  id="west_region" href="layout/west.htm" iconCls="icon-tip" split="true" title="导航菜单" style="width: 200px;"></div>
	...
	<div region="south" id="south_region" style="height: 18px; text-align: center;">版权所有&nbsp;丹东华通测控有限公司</div>
